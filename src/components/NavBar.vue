<template>
  <div>
    <nav class="menu">
      ...
      <a class="menu-item purple"><router-link to="/contact"><i class="bi bi-phone"></i></router-link></a>
      <a class="menu-item orange"><router-link to="/register"><i class="bi bi-pen"></i></router-link></a>
